...
KEYWORD_STEMS = (
    ...
    "ταμειακ", "πληρωμ",
    # Μισθοδοσία/εργατικά (από την πλευρά της επιχείρησης-εργοδότη): χωρίς αυτά, γενικά portals έχαναν αρκετά
    # εργασιακά θέματα σιωπηλά ('skipped') πριν καν φτάσουν στο LLM.
    "εργασιακ", "εργατικ", "απολυσ", "προσληψ", "υπερωρ", "συλλογικ", "κατωτατος μισθ", "ωραρι", "τηλεργασ",
    "αδειας", "αδειες", "ικα", "ενσημ", "αναγγελι", "δωρο χριστουγ", "δωρο πασχα", "επιδομα αδειας",
)
